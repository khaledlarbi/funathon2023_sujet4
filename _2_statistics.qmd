...
def figure_infos_nutritionnelles(
    ...
    example_coicop = data.loc[stats_nutritionnelles['variable'] == variable_nutritionnelle]
...
figure_infos_nutritionnelles(stats_nutritionnelles)
```
...
def figure_infos_notes(
    ...
    example_coicop = stats_notes.loc[stats_notes['variable'] == variable_note]
